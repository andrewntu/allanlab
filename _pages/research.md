...
<img src="{{ site.url }}{{ site.baseurl }}/images/cover/image_tatun.jpg" 
    alt="Cover Image" 
    style="width: 100%; max-height: 300px; object-fit: cover; border-radius: 1px;">
</div>
...
![]({{ site.url }}{{ site.baseurl }}/images/research/Figure_SI_duration_long.png){: style="width: 250px; float: center; margin: 0px  10px"}![]({{ site.url }}{{ site.baseurl }}/images/research/Steamboat_SI.jpg){: style="width: 350px; float: left; margin: 0px  10px"}
<br />
...
![]({{ site.url }}{{ site.baseurl }}/images/research/EEW.png){: style="width: 300px; float: left; margin: 0px 10px"}