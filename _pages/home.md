...
<div markdown="0" style="display: flex; align-items: center; margin-bottom: 30px;">
    ...
    <div class="photo-container" style="flex-shrink: 0; margin-right: 20px;">
        <img src="{{ site.url }}{{ site.baseurl }}/images/Photo_CNL.jpg" 
             alt="Cheng-Nan Liu" 
             style="width: 150px; height: 200px; object-fit: cover, border-radius: 5px; border: 1px solid #ddd;">
    </div>
    <!-- Introductory Text -->
...
<a href="https://orcid.org/0000-0001-6287-7631"><i class="ai ai-orcid ai-fw icon-pad-right"></i>ORCID</a>
